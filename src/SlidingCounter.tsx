...
const styles = StyleSheet.create({
    button : {height:70,width:BUTTON_WIDTH,justifyContent:'space-evenly',alignItems:'center',flexDirection:'row',backgroundColor:'#111111',borderRadius:50},
    circle : {height:50,justifyContent:'center',alignItems:'center',borderWidth:1,borderColor:'#4f4f4f',width:50,position:'absolute',borderRadius:25,backgroundColor:'#232323'},
